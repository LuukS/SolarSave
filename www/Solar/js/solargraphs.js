...
$(document).ready(function() {
    ...
    var year_chart_series = [];
    for (var i = 0; i < year_total_data.length; i++) {
        year_chart_series.push({
            type: 'column',
            name: 'Jaar totaal',
            data: year_total_data[i] // See the index for this var
        });
    }
